...
string|error token = <@untainted> generateToken(config:getAsString("CLIENT_ID"), config:getAsString("CLIENT_SECRET"), config:getAsString("TENANT_ID"));

AzureRedisConfiguration config = {
   oauth2Config: {
...
function testGetRedisCache() {
    ...
    if (response is json) {
        RedisCacheInstance testValue = {"id":"/subscriptions/"+config:getAsString("SUBSCRIPTION_ID")+"/resourceGroups/TestRedisConnector/providers/Microsoft.Cache/Redis/TestRedisConnectorCache","location":"South India","name":"TestRedisConnectorCache","type":"Microsoft.Cache/Redis","tags":{},"properties":{"provisioningState":"Succeeded","redisVersion":"4.0.14","sku":{"name":"Premium","family":"P","capacity":1},"enableNonSslPort":true,"instances":[{"sslPort":15000,"nonSslPort":13000,"isMaster":true},{"sslPort":15001,"nonSslPort":13001,"isMaster":false}],"publicNetworkAccess":"Enabled","redisConfiguration":{"maxclients":"7500","maxmemory-reserved":"200","maxfragmentationmemory-reserved":"300","maxmemory-delta":"200"},"accessKeys":null,"hostName":"TestRedisConnectorCache.redis.cache.windows.net","port":6379,"sslPort":6380,"linkedServers":[]}};
...
function testExportRedisCache() {
    ...
    var response = azureRedisClient->exportRedisCache("TestRedisConnectorCache", "TestRedisConnector", "datadump1", "https://teststorageredis.blob.core.windows.net/blobstorage", "?sv=2019-12-12&ss=bf&srt=c&sp=rwdlacx&se=2023-01-25T16:22:57Z&st=2021-01-25T08:22:57Z&spr=https&sig=DqUgEt5Jny0r1YN0PwQ0v3ebc67MB2t5b9fHMcp6px0%3D", "RDB");
    if (response is StatusCode) {
        StatusCode statusCode = <@untainted>response;
...
function testImportRedisCache() {
    ...
    var response = azureRedisClient->importRedisCache("TestRedisConnectorCache", "TestRedisConnector", "https://teststorageredis.blob.core.windows.net/blobstorage/datadump1", "RDB");
    if (response is StatusCode) {
        StatusCode statusCode = <@untainted>response;
...
function testForceRebootRedisCache() {
    ...
    var response = azureRedisClient->forceRebootRedisCache("TestRedisConnectorCache", "TestRedisConnector", 0, "AllNodes", [13000, 15001]);
    if (response is StatusCode) {
        StatusCode statusCode = <@untainted>response;
...
function testListByResourceGroup() {
    ...
    var createResponse = azureRedisClient->createRedisCache("TestRedisConnectorCacheLinkedServer","TestRedisConnector","South India", properties);
...
function testUpdateRedisCache() {
    ...
    json testValue = {"id":"/subscriptions/"+config:getAsString("SUBSCRIPTION_ID")+"/resourceGroups/TestRedisConnector/providers/Microsoft.Cache/Redis/TestRedisConnectorCache","location":"South India","name":"TestRedisConnectorCache","type":"Microsoft.Cache/Redis","tags":{},"properties":{"provisioningState":"Succeeded","redisVersion":"4.0.14","sku":{"name":"Premium","family":"P","capacity":1},"enableNonSslPort":false,"instances":[{"sslPort":15000,"isMaster":true},{"sslPort":15001,"isMaster":false}],"publicNetworkAccess":"Enabled","redisConfiguration":{"maxclients":"7500","maxmemory-reserved":"200","maxfragmentationmemory-reserved":"300","maxmemory-delta":"200"},"accessKeys":null,"hostName":"TestRedisConnectorCache.redis.cache.windows.net","port":6379,"sslPort":6380,"linkedServers":[]}};
...
function testCreateFirewallRule() {
    ...
    var response = azureRedisClient->createFirewallRule("TestRedisConnectorCache", "TestRedisConnector", "TestFilewallRule", "192.168.1.1", "192.168.1.4");
    if (response is FirewallRuleResponse) {
        FirewallRuleResponse testValue ={
                        "id": "/subscriptions/"+config:getAsString("SUBSCRIPTION_ID")+"/resourceGroups/TestRedisConnector/providers/Microsoft.Cache/redis/TestRedisConnectorCache/firewallRules/TestFilewallRule",
...
function testDeleteFireWallRule() {
    ...
    var response = azureRedisClient->deleteFirewallRule("TestRedisConnectorCache", "TestRedisConnector", "TestFilewallRule");
    if (response is StatusCode) {
        StatusCode statusCode = <@untainted>response;
...
function testCreateLinkedServer() {
    ...
    var response = azureRedisClient->createLinkedServer("TestRedisConnectorCache", "TestRedisConnector", "TestRedisConnectorCacheLinkedServer", "/subscriptions/"+config:getAsString("SUBSCRIPTION_ID")+"/resourceGroups/TestRedisConnector/providers/Microsoft.Cache/Redis/TestRedisConnectorCacheLinkedServer", "South India", "Secondary");
    if (response is json) {
        json testValue ={
            "id": "/subscriptions/"+config:getAsString("SUBSCRIPTION_ID")+"/resourceGroups/TestRedisConnector/providers/Microsoft.Cache/Redis/TestRedisConnectorCache/linkedServers/TestRedisConnectorCacheLinkedServer",
            "name": "TestRedisConnectorCacheLinkedServer",
            "type": "Microsoft.Cache/Redis/linkedServers",
            "properties": {
                "linkedRedisCacheId": "/subscriptions/"+config:getAsString("SUBSCRIPTION_ID")+"/resourceGroups/TestRedisConnector/providers/Microsoft.Cache/Redis/TestRedisConnectorCacheLinkedServer",
        ...
        json state = response.properties.provisioningState;
        while(state != "Succeeded"){
            var getresponse = azureRedisClient->getLinkedServer("TestRedisConnectorCache", "TestRedisConnector", "TestRedisConnectorCacheLinkedServer");
            if (getresponse is json) {
                state = getresponse.properties.provisioningState;
            }
        }
...
@test:Config{
    dependsOn: ["testCreateLinkedServer"]
}
function testGetLinkedServer() {
    io:println("Running GetLinkedServer Test");
    var response = azureRedisClient->getLinkedServer("TestRedisConnectorCache", "TestRedisConnector", "TestRedisConnectorCacheLinkedServer");
    if (response is json) {
...
function testDeleteLinkedServer() {
    ...
    var response = azureRedisClient->deleteLinkedServer("TestRedisConnectorCache", "TestRedisConnector", "TestRedisConnectorCacheLinkedServer");
    if (response is StatusCode) {
        StatusCode statusCode = <@untainted>response;
...
function testCreatePatchSchedule() {
    ...
    if (response is PatchShedule) {
        PatchShedule testValue ={
                        "id": "/subscriptions/"+config:getAsString("SUBSCRIPTION_ID")+"/resourceGroups/TestRedisConnector/providers/Microsoft.Cache/Redis/TestRedisConnectorCache/patchSchedules/default",
...
function testGetPatchSchedule() {
    ...
    if (response is PatchShedule) {
        PatchShedule testValue = {"id":"/subscriptions/7241b7fa-c310-4b99-a53e-c5048cf0ec25/resourceGroups/TestRedisConnector/providers/Microsoft.Cache/Redis/TestRedisConnectorCache/patchSchedules/default","location":"South India","name":"TestRedisConnectorCache/default","type":"Microsoft.Cache/Redis/PatchSchedules","properties":{"scheduleEntries":[{"dayOfWeek":"Monday","startHourUtc":12,"maintenanceWindow":"PT5H"},{"dayOfWeek":"Tuesday","startHourUtc":12,"maintenanceWindow":"PT5H"}]}}; 
...
function testListPatchSchedule() {
    ...
    if (response is PatchSheduleList) {
        PatchSheduleList testValue = {"value":[{"id":"/subscriptions/7241b7fa-c310-4b99-a53e-c5048cf0ec25/resourceGroups/TestRedisConnector/providers/Microsoft.Cache/Redis/TestRedisConnectorCache/patchSchedules/default","location":"South India","name":"TestRedisConnectorCache/default","type":"Microsoft.Cache/Redis/PatchSchedules","properties":{"scheduleEntries":[{"dayOfWeek":"Monday","startHourUtc":12,"maintenanceWindow":"PT5H"},{"dayOfWeek":"Tuesday","startHourUtc":12,"maintenanceWindow":"PT5H"}]}}]}; 
...
function testPutPrivateEndpointConnection() {
    ...
    var response = azureRedisClient->putPrivateEndpointConnection("TestRedisConnectorCache", "TestRedisConnector", "testPrivateEndpoint");
    if (response is json) {
        json testValue ={
                        "id": "/subscriptions/"+config:getAsString("SUBSCRIPTION_ID")+"/resourceGroups/TestRedisConnector/providers/Microsoft.Cache/Redis/TestRedisConnectorCache/privateEndpointConnections/testPrivateEndpoint",
                        "name": "testPrivateEndpoint",
                        "type": "Microsoft.Cache/Redis/privateEndpointConnections",
                        "properties": {
                            "provisioningState": "Succeeded",
                            "privateEndpoint": {
                            "id": "/subscriptions/"+config:getAsString("SUBSCRIPTION_ID")+"/resourceGroups/TestRedisConnector/providers/Microsoft.Network/privateEndpoints/testPrivateEndpoint"
                            },
...
function testgetPrivateEndpointConnection() {
    var response = azureRedisClient->getPrivateEndpointConnection("TestRedisConnectorCache", "TestRedisConnector", "TestPrivateEndpoint");
    if (response is json) {     
        json testValue ={
                        "id": "/subscriptions/"+config:getAsString("SUBSCRIPTION_ID")+"/resourceGroups/TestRedisConnector/providers/Microsoft.Cache/Redis/cachetest01/privateEndpointConnections/TestPrivateEndpoint",
                        "name": "TestPrivateEndpoint",
                        "type": "Microsoft.Cache/Redis/privateEndpointConnections",
                        "properties": {
                            "provisioningState": "Succeeded",
...
function testDeletePrivateEndpointConnection() {
    var response = azureRedisClient->deletePrivateEndpointConnection("TestRedisConnectorCache", "TestRedisConnector", "TestPrivateEndpoint");
    if (response is StatusCode) {
        StatusCode statusCode = <@untainted>response;
...
function testCreateRedisEnterprise() {
    var response = azureRedisClient->createRedisEnterprise("TestRedisEnterpriseCache", "TestRedisConnector", "southeastasia", "EnterpriseFlash_F300", 3);
    if (response is StatusCode) {
        StatusCode statusCode = <@untainted>response;
...
function testCreateRedisEnterpriseCacheDatabase() {
    var response = azureRedisClient->createRedisEnterpriseCacheDatabase("TestRedisEnterpriseCache", "TestRedisConnector", "default");
    if (response is StatusCode) {
        StatusCode statusCode = <@untainted>response;
        boolean createSuccess = false;
...
function testGetRedisEnterpriseCacheDatabase() {
    var response = azureRedisClient->getRedisEnterpriseCacheDatabase("TestRedisEnterpriseCache", "TestRedisConnector", "default");
    if (response is StatusCode) {
        StatusCode statusCode = <@untainted>response;
...
function testListRedisEnterpriseCacheDatabaseByCluster() {
    var response = azureRedisClient->listRedisEnterpriseCacheDatabaseByCluster("TestRedisEnterpriseCache", "TestRedisConnector");
    if (response is StatusCode) {
        StatusCode statusCode = <@untainted>response;
        boolean getSuccess = false;
        if(statusCode?.code == "200"){
...
function testListRedisEnterpriseCacheDatabaseKeys() {
    ...
    var response = azureRedisClient->listRedisEnterpriseCacheDatabaseKeys("TestRedisEnterpriseCache", "TestRedisConnector", "default");
    if (response is StatusCode) {
        StatusCode statusCode = <@untainted>response;
        boolean getSuccess = false;
        if(statusCode?.code == "200"){
...
function testRegenerateRedisEnterpriseCacheDatabaseKey() {
    ...
    var response = azureRedisClient->regenerateRedisEnterpriseCacheDatabaseKey("TestRedisEnterpriseCache", "TestRedisConnector", "default", "Primary");
    if (response is StatusCode) {
        StatusCode statusCode = <@untainted>response;
        boolean getSuccess = false;
...
function testDeleteRedisEnterpriseCacheDatabase() {
    var response = azureRedisClient->deleteRedisEnterpriseCacheDatabase("TestRedisEnterpriseCache", "TestRedisConnector", "default");
    if (response is StatusCode) {
        StatusCode statusCode = <@untainted>response;
        boolean deleteSuccess = false;
        if(statusCode?.code == "200" || statusCode?.code == "201" || statusCode?.code == "204"){
...
function testGetRedisEnterprise() {
    ...
    if (response is RedisEnterpriseCacheInstance) {
        RedisEnterpriseCacheInstance testValue = {"location":"Southeast Asia","name":"TestRedisEnterpriseCache","id":"/subscriptions/7241b7fa-c310-4b99-a53e-c5048cf0ec25/resourceGroups/TestRedisConnector/providers/Microsoft.Cache/redisEnterprise/TestRedisEnterpriseCache","type":"Microsoft.Cache/redisEnterprise","tags":{"tag1":"value1"},"sku":{"name":"EnterpriseFlash_F300","capacity":3},"properties":{"provisioningState":"Creating","resourceState":"Creating","privateEndpointConnections":[]},"zones":["1","2","3"]};
